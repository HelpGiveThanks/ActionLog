...
#
#NOTE: the ﬁnish and error script chunks are almost
...
[ Restore ]
End If
January 5, 平成26 14:08:10 ActionLog.fp7 - total -1-total: action buttons: total
...
#
January 5, 平成26 14:08:10 ActionLog.fp7 - total -2-total: action buttons: total
...
#
January 5, 平成26 14:08:10 ActionLog.fp7 - total -3-total: action buttons: total
...
[ First ]
Go to Field [ ]
January 5, 平成26 14:08:10 ActionLog.fp7 - total -4-total: action buttons: total
Halt Script
End If
#END ﬁnd error 2
#
...
January 5, 平成26 14:08:10 ActionLog.fp7 - total -5-total: action buttons: total
Set Field [ day2::swPause; Case (
$TotalActivity > Time ( 23 ; 59 ; 59 ) ; day2::_keyDay & " 24:00:00" ;
$TotalActivity < Time ( 0 ; 0 ; 0 ) ; day2::_keyDay & " 00:00:00" ;
day2::_keyDay & " " & $TotalActivity )
...
Go to Record/Request/Page
[ Next; Exit after last ]
January 5, 平成26 14:08:10 ActionLog.fp7 - total -6-total: action buttons: total Go to Record/Request/Page
[ Next; Exit after last ]
End Loop
#
...
#
End Loop
January 5, 平成26 14:08:10 ActionLog.fp7 - total -7-
