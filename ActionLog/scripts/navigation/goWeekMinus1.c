...
January 5, 平成26 14:34:41 ActionLog.fp7 - goWeekMinus1 -1-navigation: goWeekMinus1
Set Field [ brainstate::monthsumdays;
(
If ( day1::swTotalActivity ≠ 0 ; 1 ; 0 ) +
If ( day2::swTotalActivity ≠ 0 ; 1 ; 0 ) +
...
Go to Record/Request/Page
[ First ]
January 5, 平成26 14:34:41 ActionLog.fp7 - goWeekMinus1 -2-
