navigation: CalendarMonthCalcChartSortN
...
January 5, 平成26 19:00:16 ActionLog.fp7 - CalendarMonthCalcChartSortN -1-navigation: CalendarMonthCalcChartSortN
Set Field [ brainstate::monthsumaverage; If (
If ( day1::swTotalActivity ≠ 0 ; 1 ; 0 ) +
If ( day2::swTotalActivity ≠ 0 ; 1 ; 0 ) +
If ( day3::swTotalActivity ≠ 0 ; 1 ; 0 ) +
...
If ( day30::swTotalActivity ≠ 0 ; 1 ; 0 ) +
If ( day31::swTotalActivity ≠ 0 ; 1 ; 0 ) ]
January 5, 平成26 19:00:16 ActionLog.fp7 - CalendarMonthCalcChartSortN -2-navigation: CalendarMonthCalcChartSortN
Set Field [ brainstate::monthsumdays; If ( day1::swTotalActivity ≠ 0 ; 1 ; 0 ) +
If ( day2::swTotalActivity ≠ 0 ; 1 ; 0 ) +
If ( day3::swTotalActivity ≠ 0 ; 1 ; 0 ) +
If ( day4::swTotalActivity ≠ 0 ; 1 ; 0 ) +
...
Go to Record/Request/Page
[ First ]
January 5, 平成26 19:00:16 ActionLog.fp7 - CalendarMonthCalcChartSortN -3-
