navigation: total: CalendarWeekCalcTotal
...
January 5, 平成26 19:19:02 ActionLog.fp7 - CalendarWeekCalcTotal -1-navigation: total: CalendarWeekCalcTotal
Set Field [ brainstate::monthsumdays;
(
If ( day1::swTotalActivity ≠ 0 ; 1 ; 0 ) +
If ( day2::swTotalActivity ≠ 0 ; 1 ; 0 ) +
...
Go to Record/Request/Page
[ First ]
January 5, 平成26 19:19:02 ActionLog.fp7 - CalendarWeekCalcTotal -2-
