...
// Perform Script [ “ActivityLog!!!!ﬁndAllBrainstateLogs” ]
// End If
Select Window [ Name: "Timer"; Current ﬁle ]
#
#4 check if the record belongs to a total record and modify its foldercheck ﬁeld if so to inform user on main screen that a stopwatch may be
...
#gets ID number.(Would be better to ﬁx sort
