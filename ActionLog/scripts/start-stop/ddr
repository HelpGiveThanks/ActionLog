...
Tables	1	 	Default custom menu set	BrainstateConversationManager
Relationships	0	 	When opening file
Layouts	0	 	Login using	Account Name; Account= normal
Scripts	243	 	Switch to layout	01Main
Value Lists	0	 	Perform script	start
Custom Functions	0	 	When closing file
Accounts	0	 	Perform script	close
Privilege Sets	0
...
Recovered Library	
1 field defined, 3 records
	

Fields
Table Name: Recovered Library - 1 Fields
Field Name	Type	Options	Comments	On Layouts	In Relationships	In Scripts	In Value Lists
Recovered Blob	Normal, Binary	Auto-Enter:
