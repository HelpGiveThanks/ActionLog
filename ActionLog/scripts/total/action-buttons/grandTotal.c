...
#
#
#A) BEGIN ﬁnd selected GRAND total records and create new total record and link all records together
#
...
clicking or hovering over the i at the far right of this description ﬁeld." ]
...
End Loop
#
#A) END ﬁnd selected merge records and create new GRAND total record and link all records together
#
#
#
Loop
