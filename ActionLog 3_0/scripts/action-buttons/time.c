action buttons: time
#PURPOSE script attached to the time button on the edit time layouts. It checks if user is in a time ﬁeld, and if they are inserts the current time
...
End If
#
#1 determine if the user is in a time ﬁeld
...
Show Custom Dialog [ Title: "!"; Message: "This button is for inserting the current time into a stop or start time ﬁeld."; Buttons: “OK” ]
