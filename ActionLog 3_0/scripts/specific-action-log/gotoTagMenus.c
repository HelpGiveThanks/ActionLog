...
Move/Resize Window [ Current Window; Width: 550; Left: If (Get (ScreenWidth) / 2 + 550 ≤ Get (ScreenWidth) ; Get (ScreenWidth)
/2 ; Get (ScreenWidth) - 550 ) ]
Else If [ Get ( WindowZoomLevel ) = 300 ]
Move/Resize Window [ Current Window; Width: 830; Left: If (Get (ScreenWidth) / 2 + 830 ≤ Get (ScreenWidth) ; Get (ScreenWidth)
/2 ; Get (ScreenWidth) - 830 ) ]
Else If [ Get ( WindowZoomLevel ) = 400 ]
Move/Resize Window [ Current Window; Width: 1100; Left: If (Get (ScreenWidth) / 2 + 1100 ≤ Get (ScreenWidth) ; Get (ScreenWidth)
/2 ; Get (ScreenWidth) - 1100 ) ]
